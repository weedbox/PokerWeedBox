...
func DebugPrintTableGameOpened(t pwbtable.Table) {
...
func DebugPrintTableGameSettled(t pwbtable.Table) {
	timeString := func(timestamp int64) string {
		return time.Unix(timestamp, 0).Format("2006-01-02 15:04:00.000")
	}

	playerIDMapper := func(t pwbtable.Table, gameStatePlayerIdx int) string {

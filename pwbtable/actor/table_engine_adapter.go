...
type tableEngineAdapter struct {
	actor  Actor
	engine pwbtable.TableEngine
	table  *pwbtable.Table
}

func NewTableEngineAdapter(te pwbtable.TableEngine, table *pwbtable.Table) *tableEngineAdapter {
...
func (tea *tableEngineAdapter) UpdateTableState(tableInfo *pwbtable.Table) error {
